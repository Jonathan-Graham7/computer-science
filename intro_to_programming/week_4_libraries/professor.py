...
the user for a level and returns 1, 2, or 3, and generate_integer returns a randomly generated non-negative integer with level digits
...
def generate_integer(level):
    if level == 1:
        ...
        integer = random.randrange(10 ** (level - 1), 10 ** level)
    return integer
