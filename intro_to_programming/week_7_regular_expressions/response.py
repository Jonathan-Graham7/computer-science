...
it's possible to enable response validation and require that the user's input match a regular expression.
...
per the screenshot below, much like you could use a library in your own code:
